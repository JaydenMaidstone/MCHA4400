...
Eigen::Vector2d StateSLAM::predictFeature(const Eigen::VectorXd & x, Eigen::MatrixXd & J, const Camera & cam, std::size_t idxLandmark) const
{
    // Set elements of J
    // TODO: Lab 7 (optional)
    Eigen::Vector3<autodiff::dual> xduel = x.cast<autodiff::duel>();
    Eigen::Vector2<autodiff::dual> fduel; // Build expression tree
    J = jacobian(vectorToPixel<autodiff::dual>, wrt(x_dual), at(cam, x_dual), fduel);
